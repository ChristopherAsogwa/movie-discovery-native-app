...
<h3 align="center">A Movie Discovery App with Advanced Search</h3>

   <div align="center">
    A native mobile app that lets users explore trending movies, search for titles, and view key details such as release year and budget, all fetched in real time from an external movie API.
    </div>
</div>
...
This repository contains the code corresponding to this native app.

## <a name="introduction">🤖 Introduction</a>

Built with Expo, TypeScript, and Tailwind CSS, this app retrieves movie data and implements a popularity algorithm powered by Appwrite. It delivers a smooth browsing experience by ranking movies based on multiple engagement metrics. Designed with modern UI/UX principles, the app offers a responsive, visually engaging interface built for real-world scalability and performance.
...
```bash
git clone https://github.com/ChristopherAsogwa/movie-discovery-native-app.git
